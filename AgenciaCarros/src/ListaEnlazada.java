...
public class ListaEnlazada<E> {
	...
	public E inicio() {
		try {
			...
			throw new NoSuchElementException("No se puede regresar el primer elemento de una lista enlazada vac�a");
		}
	...
	public E fin() {
		try {
			...
			throw new NoSuchElementException("No se puede regresar el �ltimo elemento de una lista enlazada vac�a");
		}
	}
	...
	public E borrarInicio() {
		try {
			...
			throw new IndexOutOfBoundsException("No puedes borrar el inicio de una lista vac�a");
		}
	}
	...
	public void insertarEn(E dato, int pos) throws IndexOutOfBoundsException {
		int cont = 0;
		if (pos > this.size || pos<0) {
			throw new IndexOutOfBoundsException("La posici�n ingresada excede el tama�o del arreglo.");
		}
		if (estaVacia()) {
			insertarInicio(dato);
		} else if(pos == 0) {
